...
{
    public class CustomerAddRequestTest
    {
        private CustomerAddRequestValidator validator;

        public CustomerAddRequestTest()
        {
            validator = new CustomerAddRequestValidator();
        }
        ...
        {
            var model = new CustomerAddRequest { Nome = nome };
        ...
        {
            var model = new CustomerAddRequest { Nome = "12345" };
            var result = validator.TestValidate(model);
